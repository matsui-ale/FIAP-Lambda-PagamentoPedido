...
Execute unit tests
```
    cd "FIAP.TechChallenge.LambdaPagamentoPedido/test/FIAP.TechChallenge.LambdaPagamentoPedido.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "FIAP.TechChallenge.LambdaPagamentoPedido/src/FIAP.TechChallenge.LambdaPagamentoPedido"
